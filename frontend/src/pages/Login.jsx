...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    setLoading(true);
    try {
      const auth = await LegalAPI.login(email, password);
      persistSession(auth);
      navigate('/chat');
    } catch (err) {
    ...
    <div className="login-page">
      <section className="login-hero">
        ...
        <div className="hero-content">
          <h1>Tư vấn, hỏi đáp<br />về luật Thuế Việt Nam</h1>
          <p>Tra cứu nhanh hơn, chính xác hơn với AI được huấn luyện trên hơn 20,000 văn bản pháp lý về thuế chính thức.</p>
      ...
      <section className="login-form-panel">
        ...
        <p className="footer-text">
          Chưa có tài khoản? <a href="/register" onClick={e => { e.preventDefault(); navigate('/register'); }}><strong>Đăng ký miễn phí</strong></a>
        </p>
      </section>
    </div>
  );
